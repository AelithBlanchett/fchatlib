...
var parent;
var pingInterval;
var fileRoomsJs = process.cwd()+"/config/config.rooms.js";
...
class FChatLib {
    ...
    constructor(configFile){
        ...
        //this.addMessageListener(commandHandler); //basic commands + plugins loader, one instance for all bots
    ...
    generateCommandHandlers() {
        ...
        parent.channels.forEach(function (room) {
    ...
    joinNewChannel(channel){
        if(parent.channels.indexOf(channel) == -1){
        ...
        //save file for rooms
        jsonfile.writeFile(fileRoomsJs, parent.channels);
    }
