...
var FChatLib = (function () {
    ...
    FChatLib.prototype.setStatus = function (status, message) {
        parent.sendWS('STA', { status: status, statusmsg: message });
    };
    ...
    FChatLib.prototype.sendPrivMessage = function (message, character) {
        var json = {};
        json.message = message;
    ...
    FChatLib.prototype.isUserMaster = function (username, channel) {
...
//# sourceMappingURL=libfchat.js.map