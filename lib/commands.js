...
function loadPlugin(pluginName){
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        newHandler = Object.getPrototypeOf(newHandler);
        //lowercase alias
...
function loadPluginOnStart(pluginsPathArray) {
    ...
    for (var i = 0; i < pluginsPathArray.length; i++) {
        ...
        newHandler = Object.getPrototypeOf(newHandler);
        //lowercase alias
        for(var j = 0; j < Object.getOwnPropertyNames(newHandler).length; j++){
            strAddedCommands += "!"+Object.getOwnPropertyNames(newHandler)[j].toLowerCase() + ", ";
            if(Object.getOwnPropertyNames(newHandler)[j].toLowerCase() != Object.getOwnPropertyNames(newHandler)[j]){
                newHandler[Object.getOwnPropertyNames(newHandler)[j].toLowerCase()] = newHandler[Object.getOwnPropertyNames(newHandler)[j]];
            }
        }
        commandHandler = Object.assign(commandHandler,newHandler);
