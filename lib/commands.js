...
commandHandler.channel = function (args, data) {
    fChatLibInstance.sendMessage('The message was sent in the room:'+ data.channel + ' and the command handler receiving it knows this channel: '+channelName, data.channel);
};
...
function loadPlugins(pluginsDir){
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        var newHandler = require(files[i])(fChatLibInstance, channelName);
